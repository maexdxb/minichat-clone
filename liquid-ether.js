 ...
 * Refined "Wave-Glow" Version
 * Balanced for visible ripples that disappear quickly.
 */
...
class LiquidEther {
    constructor(container, options = {}) {
        ...
        this.options = {
            mouseForce: options.mouseForce !== undefined ? options.mouseForce : 200,
            cursorSize: options.cursorSize !== undefined ? options.cursorSize : 45, // Balanced thickness
            iterationsPoisson: options.iterationsPoisson || 32,
            dt: 0.012,
            resolution: options.resolution || 0.6,
            colors: options.colors || ['#91738d', '#c39da8', '#ff00cc'], // Website Pink
            ...
            dissipation: 0.88 // Disappears quickly but smoothly
        };
    ...
    init() {
        ...
        const color_frag = `
            ...
            void main() {
                ...
                float glow = smoothstep(0.0, 0.4, lenv);
                glow = pow(glow, 0.75); // Stronger light falloff
